...
var links = document.querySelectorAll('nav a'); // Listen the `NAVIGATE_IN` event
...
H.on('NAVIGATE_IN', function (_ref) {
  ...
  console.log(to);
  console.log(location); // Check Active Link

  for (var i = 0; i < links.length; i++) {
    var link = links[i]; // Clean class

    link.classList.remove('is-active'); // Active link
